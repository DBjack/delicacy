...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"美食分享","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var b = "development" === "development",
  ...
  A = T({"address":["127.0.0.1","192.168.1.13"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","D:/工作软件/HBuilderX/plugins/unicloud/**/*.js"]}),
  O = T([{"provider":"aliyun","spaceName":"delicacy","spaceId":"mp-628da86e-609f-48e5-aa87-60ba8f902f1a","clientSecret":"yhXRCYlkauv9SpOx8WJwzg==","endpoint":"https://api.next.bspapp.com"}]) || [],
  x = true;
var N = "";
try {
