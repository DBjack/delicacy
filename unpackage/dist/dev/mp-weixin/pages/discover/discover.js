...
var _discover = _interopRequireDefault(__webpack_require__(/*! ./pages/discover/discover.vue */ 47));
// @ts-ignore
...
/* harmony import */ var _discover_vue_vue_type_template_id_42b8c6b4___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./discover.vue?vue&type=template&id=42b8c6b4& */ 48);
/* harmony import */ var _discover_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./discover.vue?vue&type=script&lang=js& */ 50);
...
/* harmony import */ var _discover_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./discover.vue?vue&type=style&index=0&lang=scss& */ 52);
...
var render = function () {
  ...
  var l0 = _vm.__map(_vm.hotPosts, function (post, __i1__) {
    var $orig = _vm.__get_orig(post)
    var m0 = _vm.formatNumber(post.likeCount)
    var m1 = _vm.formatNumber(post.collectCount)
    return {
      $orig: $orig,
      m0: m0,
      m1: m1,
  ...
  data: function data() {
    return {
      ...
      navItems: [{
        ...
        name: "排行榜",
        icon: "/static/images/nav/rank.png",
        type: "rank"
      }, {
        name: "食谱",
        icon: "/static/images/nav/recipe.png",
        type: "recipe"
      }, {
        name: "达人",
        icon: "/static/images/nav/expert.png",
        type: "expert"
      }],
      hotTags: [],
      hotPosts: [],
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return Promise.all([_this.loadHotTags(), _this.loadHotPosts()]);
              case 2:
              case "end":
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                _this2.hotTags = res.result.data;
                _context2.next = 9;
                break;
              case 8:
              ...
              case 11:
                ...
                console.error("获取热门标签失败:", _context2.t0);
                uni.showToast({
                  title: "获取热门标签失败",
                  icon: "none"
                });
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 6:
                ...
                if (_this3.page === 1) {
                  _this3.hotPosts = posts;
                } else {
                  _this3.hotPosts = [].concat((0, _toConsumableArray2.default)(_this3.hotPosts), (0, _toConsumableArray2.default)(posts));
                }
              ...
              case 16:
                ...
                console.error("获取热门帖子失败:", _context3.t0);
                uni.showToast({
                  title: "获取热门帖子失败",
                  icon: "none"
                });
